...
/**
 * A brainstorm.SimpleCanvas represents a window on the screen that can be drawn on.
 */
public class SimpleCanvas {
    ...
    /**
     * Creates a new brainstorm.SimpleCanvas of the specified width and height.
     */
    ...
    /**
     * Creates a new brainstorm.SimpleCanvas of the specified width and height, with the specified title.
     */
